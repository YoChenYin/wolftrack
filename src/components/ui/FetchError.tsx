  ...
  return (
    <div className="mt-2 flex items-center gap-2 text-xs text-zinc-400 dark:text-zinc-500">
      ...
      <button
        type="button"
        onClick={onRetry}
        className="inline-flex items-center gap-1 rounded-full bg-zinc-100 px-2 py-0.5 font-medium text-zinc-600 transition-colors hover:bg-zinc-200 dark:bg-white/10 dark:text-zinc-300 dark:hover:bg-white/15"
      >
